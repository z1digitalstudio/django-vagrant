...
apt-get -y install libjpeg-dev libpng12-dev
apt-get -y install python-lxml python-cffi libcairo2 libpango1.0-0 libgdk-pixbuf2.0-0 shared-mime-info
...
apt-get update
apt-get -y install postgresql-9.4 postgresql-server-dev-9.4 pgadmin3 python-psycopg2
